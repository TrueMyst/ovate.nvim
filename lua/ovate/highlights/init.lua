...
M.theme = function(C, O)
    return {
        ...
        LspInlayHint = {fg = C.white, bg = C.background}, -- virtual text of the inlay hints
        ...
        ["@lsp.typemod.function.defaultLibrary.javascript"] = {
            fg = C.bright_green
        },
        ...
        -- Fidget
        FidgetTask = {fg = C.aurora, bg = C.lemon_yellow},
